...
<style scoped>
    ...
    .rename-input {
        width: 93%; padding: 12px; background: #150f24;
        border: 1px solid #6d5bd0; border-radius: 8px;
    ...
    .btn-submit { background: #8b5cf6; color: #ffffff; border: none; flex: 1; padding: 12px; border-radius: 8px; font-weight: bold; cursor: pointer; }
    .btn-submit:hover:not(:disabled) { background: #7c3aed; }
    .btn-submit:disabled { opacity: 0.5; cursor: not-allowed; }

    .btn-cancel { background: transparent; border: 1px solid #6d5bd0; color: #94a3b8; flex: 1; padding: 12px; border-radius: 8px; cursor: pointer; transition: 0.2s; }
    .btn-cancel:hover { background: #3d3560; color: #fff; }
